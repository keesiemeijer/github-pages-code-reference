...
function wporg_developer_child_get_localized_strings() {
	...
	$strings = array(
		...
		'functions_label'      => __( 'Functions: %1$s', 'wporg-developer-child' ),
		'classes'              => __( 'Classes', 'wporg-developer-child' ),
		'class'                => __( 'Class', 'wporg-developer-child' ),
		'classes_label'        => __( 'Classes:  %1$s', 'wporg-developer-child' ),
		'hooks'                => __( 'Hooks', 'wporg-developer-child' ),
		'hook'                => __( 'Hook', 'wporg-developer-child' ),
		'hooks_label'          => __( 'Hooks: %1$s', 'wporg-developer-child' ),
		...
		'filter_version'       => __( 'Filter by version:', 'wporg-developer-child' ),
		'filter_status'        => __( 'Filter by status:', 'wporg-developer-child' ),
		...
		'status_not_found'     => __( 'No %1$s %2$s found', 'wporg-developer-child' ),
		'found'                => __( '%1$d %2$s found', 'wporg-developer-child' ),
		'status_found'         => __( '%1$d %2$s %3$s found', 'wporg-developer-child' ),
	);
